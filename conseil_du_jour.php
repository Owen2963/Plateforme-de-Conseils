...
<body>
    <h1 class="titre">Conseil du jour</h1>
    <nav class="navbar">
        <ul>
            <li><b><a href="accueil.php">Accueil</a></b></li>
            <li><b><a href="nos_conseils.php">Nos Conseils</a></b></li>
            <li class="page_actuel"><b><a href="conseil_du_jour.php">Conseil du joour</a></b></li>
  ...
  // Chemin vers le dossier des articles
        ...
        // Tableau pour stocker tous les conseils
        $all_conseils = $static_conseils;
        ...
        if (file_exists($nom_dossier)) {
            ...
            // Ajouter chaque conseil dynamique au tableau all_conseils
        ...
        if (count($all_conseils) > 0) {
            $conseil_aleatoire = $all_conseils[array_rand($all_conseils)];

            echo "<div class='conseil_texte'>";
            echo "<h1 class='conseil_titre'>" . htmlspecialchars($conseil_aleatoire['titre']) . "</h1>";
            echo "<p><b>" . nl2br(htmlspecialchars($conseil_aleatoire['conseil'])) . "</b></p>";
            echo "</div>";
        } else {
            echo "<p>Aucun conseil disponible pour le moment.</p>";
        }
        ?>
    </main>
</body>
